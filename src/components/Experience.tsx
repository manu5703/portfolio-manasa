...
const experiences = [
  {
    ...
    description: [
      "Assisted and supervised students in their final project of building a prototype of an AI-based solution to a real-time business problem.",
      "Guided students on web development, cloud deployment, and machine learning aspects of their projects.",
